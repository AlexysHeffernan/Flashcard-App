...
Studying a deck with two or fewer cards displays a "Not enough cards" message (see the "Not enough cards" section below) and a button to add cards to the deck.
Next button
